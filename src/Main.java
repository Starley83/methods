...
public class Main {
    public static boolean checkingLeapYear(int date) {// check year
        if (date < 1584) {
            return false;
    ...
    public static void CheckingUserPhone(int OS, int year) {
    ...
    public static void main(String[] args) {
        ...
        CheckingUserPhone(clientOS, clientDeviceYear);
